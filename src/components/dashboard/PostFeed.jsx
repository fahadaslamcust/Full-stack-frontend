      ...
      {posts.map((post) => (
        ...
        >
          ...
          <div className="flex items-center justify-between gap-3 w-full">
            ...
            {post.isFollowing ? (
              <button className="text-[11px] sm:text-xs font-semibold text-gray-400 border border-gray-200 rounded-full px-3 py-1 bg-gray-50 hover:bg-gray-100 transition shrink-0">
                Following
              </button>
            ) : (
              <button className="text-[11px] sm:text-xs font-semibold text-white bg-[#4285F4] rounded-full px-3.5 py-1 hover:bg-blue-500 transition shrink-0 shadow-xs">
                + Follow
              </button>
            )}
          </div>
          ...
          {/* Image */}
          {post.image && (
            <div className="rounded-xl overflow-hidden bg-gray-50 border border-gray-100 w-full max-h-85 flex items-center justify-center">
              <img
          ...
          <div className="flex items-center space-x-6 pt-2 text-xs border-t border-gray-50 w-full">
            ...
            >
              <svg
                className={`w-4 h-4 transform group-hover:scale-110 transition ${
                  post.liked ? "fill-blue-500" : "fill-gray-300"
                }`}
                viewBox="0 0 24 24"
              >
            ...
            {/* Comment */}
            <button className="flex items-center space-x-1.5 hover:text-gray-900 group transition text-gray-500">
              <svg
                className="w-4 h-4 transform group-hover:scale-110 transition"
                fill="none"
                stroke="currentColor"
