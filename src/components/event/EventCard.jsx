...
export default function EventCard({ title, image, dateBadge, location, time, description}) {
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3 px-1">
        ...
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs font-medium text-gray-400">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2">
          <p className="text-base font-normal text-gray-500 leading-snug max-w-sm">
