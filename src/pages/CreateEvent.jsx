import { Type, Calendar, MapPin } from "lucide-react"; // Matching Screenshot style icons
      ...
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-2">
            <button
              type="submit"
              className="w-full py-3.5 bg-[#4285F4] text-white rounded-xl font-semibold text-sm shadow-md shadow-blue-200 hover:bg-blue-600 transition duration-200"
            >
              Create Event
            </button>
          </div>
